...
public class ExplicitWait {
    ...
    public void waitForVisibility(){
        ...
        wait.until(ExpectedConditions.visibilityOf(submitBtn));//until element becomes visible waits
        wait.until(ExpectedConditions.elementToBeClickable(submitBtn)).click();//until element becomes clickable waits then click
    ...
    public void elementToBeClickableTest(){
       ...
       // WebDriverWait wait = new WebDriverWait(driver, 15);
        ...
        ////div[@class='loadingoverlay'] ....just when it is visible and overlay this xpath code is  working
